...
use sp_api::{
	ApiExt, ApiRef, CallApiAt, CallApiAtParams, Core as CoreApi, Metadata as MetadataApi,
	ProvideRuntimeApi,
};
...
use sc_service::{SpawnTaskHandle, TaskExecutor};
...
impl<B, E, Block> BlockOf for Client<B, E, Block>
where
...
where
	...
	<Self as ProvideRuntimeApi<Block>>::Api: MetadataApi<Block>,
{
...
where
	...
	<Client<B, E, Block> as ProvideRuntimeApi<Block>>::Api: MetadataApi<Block>,
{
	fn lock_import_and_run<R, Err, F>(&self, f: F) -> Result<R, Err>
	where
		F: FnOnce(&mut ClientImportOperation<Block, B>) -> Result<R, Err>,
...
impl<B, E, Block> Client<B, E, Block>
where
	B: backend::Backend<Block> + 'static,
	E: CallExecutor<Block>,
	Block: BlockT,
	...
	// C::StateBackend: sp_api::StateBackend<sp_api::HashFor<Block>,>
{
	...
	where
		...
		<Self as ProvideRuntimeApi<Block>>::Api:
			CoreApi<Block> + ApiExt<Block, StateBackend = B::State> + MetadataApi<Block>,
	{
		...
		let import_headers = if post_digests.is_empty() {
			PrePostHeader::Same(header.clone())
		} else {
			let mut post_header = header.clone();
			for item in post_digests {
				post_header.digest_mut().push(item);
			}
			PrePostHeader::Different(header.clone(), post_header)
		};
			...
			CoreApi<Block> + ApiExt<Block, StateBackend = B::State> + MetadataApi<Block>,
	{
		...
		let block_origin_hash = header.hash();
		let block_origin_phash = *header.parent_hash();
		info!(
...
impl<B, E, Block> UsageProvider<Block> for Client<B, E, Block>
where
	B: backend::Backend<Block> + 'static,
	E: CallExecutor<Block>,
	Block: BlockT,
...
impl<B, E, Block> ProofProvider<Block> for Client<B, E, Block>
where
	B: backend::Backend<Block> + 'static,
	E: CallExecutor<Block>,
	Block: BlockT,
...
impl<B, E, Block> StorageProvider<Block, B> for Client<B, E, Block>
where
	B: backend::Backend<Block> + 'static,
	E: CallExecutor<Block>,
	Block: BlockT,
...
impl<B, E, Block> HeaderMetadata<Block> for Client<B, E, Block>
where
	B: backend::Backend<Block> + 'static,
	E: CallExecutor<Block>,
	Block: BlockT,
...
impl<B, E, Block> ProvideUncles<Block> for Client<B, E, Block>
where
	B: backend::Backend<Block> + 'static,
	E: CallExecutor<Block>,
	Block: BlockT,
...
impl<B, E, Block> ChainHeaderBackend<Block> for Client<B, E, Block>
where
	B: backend::Backend<Block> + 'static,
...
impl<B, E, Block> sp_runtime::traits::BlockIdTo<Block> for Client<B, E, Block>
where
	B: backend::Backend<Block> + 'static,
	E: CallExecutor<Block> + Send + Sync,
	Block: BlockT,
...
impl<B, E, Block> ProvideCache<Block> for Client<B, E, Block>
where
	B: backend::Backend<Block> + 'static,
	Block: BlockT,
	NumberFor<Block>: Into<u32>,
...
impl<B, E, Block> ProvideRuntimeApi<Block> for Client<B, E, Block>
where
	B: backend::Backend<Block> + 'static,
	...
	NumberFor<Block>: Into<u32>,
{
	type Api = MockRuntimeApi<B, Self, Block>;
	fn runtime_api<'a>(&'a self) -> ApiRef<'a, Self::Api>
	where
		Self: CallApiAt<Block, StateBackend = B::State> + 'static + Send + Sync,
	{
		MockRuntimeApi {
	...
	NumberFor<Block>: Into<u32>,
{
	...
	>(
		...
		let r = self.executor.contextual_call::<_, fn(_, _) -> _, _, _>(
			|| {
				core_api
...
impl<B, E, Block> sp_consensus::BlockImport<Block> for &Client<B, E, Block>
where
	B: backend::Backend<Block> + 'static,
	E: CallExecutor<Block> + Send + Sync,
	Block: BlockT,
	NumberFor<Block>: Into<u32>,
	Client<B, E, Block>: ProvideRuntimeApi<Block>,
	<Client<B, E, Block> as ProvideRuntimeApi<Block>>::Api:
		CoreApi<Block> + ApiExt<Block, StateBackend = B::State> + MetadataApi<Block>,
	backend::TransactionFor<B, Block>: Send + 'static,
{
	...
	async fn import_block(
		...
		let import_result = self
			.lock_import_and_run(|operation| self.apply_block(operation, import_block, new_cache))
			.map_err(|e| {
...
impl<B, E, Block> Finalizer<Block, B> for Client<B, E, Block>
where
	B: backend::Backend<Block> + 'static,
	E: CallExecutor<Block>,
	Block: BlockT,
	...
	<Self as ProvideRuntimeApi<Block>>::Api: MetadataApi<Block>,
{
	fn apply_finality(
		...
		info!(target: "client", "apply_finality block:{}", id);
	...
	fn finalize_block(
		...
		info!(target: "client", "finalize_block block:{}", id);
...
where
	...
	NumberFor<Block>: Into<u32>,
	Self: ProvideRuntimeApi<Block>,
	<Self as ProvideRuntimeApi<Block>>::Api: CoreApi<Block> + MetadataApi<Block>,
{
...
where
	...
	NumberFor<Block>: Into<u32>,
	Client<B, E, Block>: ProvideRuntimeApi<Block>,
	<Client<B, E, Block> as ProvideRuntimeApi<Block>>::Api: CoreApi<Block> + MetadataApi<Block>,
{
	fn insert_aux<
		'a,
		'b: 'a,
