...
use sp_api::{
	ApiError, ApiExt, CallApiAt, CallApiAtParams, InitializeBlock, RuntimeApiInfo, StorageChanges,
	StorageTransactionCache, TransactionOutcome,
};
...
unsafe impl<B, C, Block> Sync for MockRuntimeApi<B, C, Block>
where
	Block: BlockT,
	C: CallApiAt<Block, StateBackend = B::State> + 'static + Send + Sync,
	// C::StateBackend: sp_api::StateBackend<sp_api::HashFor<Block>>,
...
unsafe impl<B, C, Block> Send for MockRuntimeApi<B, C, Block>
where
	Block: BlockT,
	C: CallApiAt<Block, StateBackend = B::State> + 'static + Send + Sync,
	// C::StateBackend: sp_api::StateBackend<sp_api::HashFor<Block>>,
...
impl<B, C, Block> MockRuntimeApi<B, C, Block>
where
	Block: BlockT,
	C: CallApiAt<Block, StateBackend = B::State> + 'static + Send + Sync,
	// C::StateBackend: sp_api::StateBackend<sp_api::HashFor<Block>>,
...
// impl<B, C, Block> CallApiAt<Block> for MockRuntimeApi<B, C, Block>
//     where
//         Block: BlockT,
//         C: CallApiAt<Block, StateBackend=B::State> + 'static + Send + Sync,
//         B: sc_client_api::backend::Backend<Block> + 'static + Send + Sync,{
...
impl<B, C, Block> ApiExt<Block> for MockRuntimeApi<B, C, Block>
where
	Block: BlockT,
	C: CallApiAt<Block, StateBackend = B::State> + 'static + Send + Sync,
	// C::StateBackend: sp_api::StateBackend<sp_api::HashFor<Block>>,
...
impl<B, C, Block> sp_api::Core<Block> for MockRuntimeApi<B, C, Block>
where
	Block: BlockT,
	C: CallApiAt<Block, StateBackend = B::State> + 'static + Send + Sync,
	// C::StateBackend: sp_api::StateBackend<sp_api::HashFor<Block>>,
...
impl<B, C, Block> sp_api::Metadata<Block> for MockRuntimeApi<B, C, Block>
where
	Block: BlockT,
	C: CallApiAt<Block, StateBackend = B::State> + 'static + Send + Sync, // + sp_api::Core<Block>,
	// C::StateBackend: sp_api::StateBackend<sp_api::HashFor<Block>>,
	B: sc_client_api::backend::Backend<Block> + 'static + Send + Sync,
	// B::State: sp_api::StateBackend<sp_api::HashFor<Block>>,
{
...
impl<B, C, Block> sp_block_builder::BlockBuilder<Block> for MockRuntimeApi<B, C, Block>
where
	Block: BlockT,
	C: CallApiAt<Block, StateBackend = B::State> + 'static + Send + Sync,
	// C::StateBackend: sp_api::StateBackend<sp_api::HashFor<Block>>,
...
impl<B, C, Block> fg_primitives::GrandpaApi<Block> for MockRuntimeApi<B, C, Block>
where
	Block: BlockT,
	C: CallApiAt<Block, StateBackend = B::State> + 'static + Send + Sync,
	// C::StateBackend: sp_api::StateBackend<sp_api::HashFor<Block>>,
...
impl<B, C, Block> sp_consensus_babe::BabeApi<Block> for MockRuntimeApi<B, C, Block>
where
	Block: BlockT,
	C: CallApiAt<Block, StateBackend = B::State> + 'static + Send + Sync,
	// C::StateBackend: sp_api::StateBackend<sp_api::HashFor<Block>>,
...
impl<B, C, Block> sp_session::SessionKeys<Block> for MockRuntimeApi<B, C, Block>
where
	Block: BlockT,
	C: CallApiAt<Block, StateBackend = B::State> + 'static + Send + Sync,
	// C::StateBackend: sp_api::StateBackend<sp_api::HashFor<Block>>,
