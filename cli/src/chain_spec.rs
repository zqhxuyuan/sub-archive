...
pub type ArchiveChainSpec = GenericChainSpec<GenesisConfig, Extensions>;
...
pub fn development_config() -> Result<ArchiveChainSpec, String> {
    Ok(ArchiveChainSpec::from_genesis(
        "Development",
        "dev",
